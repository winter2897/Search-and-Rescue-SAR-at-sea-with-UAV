...
#RUN CODE: python Get_Video_Dataset.py --radius 10 --altitude 8 --speed 4 --center "10,0" --iterations 1
#-------------------------------------------
import setup_path 
import airsim
import os
...
class OrbitNavigator:
    ...
    def start(self):
        ...
        frame_width = 512
        frame_height = 288
        out = cv2.VideoWriter('SAR_10_8_6_4.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (frame_width,frame_height))
